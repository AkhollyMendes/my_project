<div class="titulototalalunos">arquivados</div>



<div class="linha">
			<form onsubmit="return false;" name="buscador" id="buscaalunos" action="./detalhes_resultado.php" method="post" autocomplete="off" enctype="multipart/form-data">
			    ...
			    <div id="rs_busca" class="">
					...
					<div id="rs_resposta">
						<?php include('./detalhes_resultado.php'); ?>
			    ...
			    <div id="rs_deletealuno" class="hidden">
					...
					<div class="centralizaconteudo">
						<div class="rss_del rss_delconfirm" data="" id="confirmadeletaraluno">deletar?</div>
						<div class="rss_del rss_delcancela" onclick="cancela();">cancelar</div>
					</div>
 				...
 				<div id="rs_desarquivaaluno" class="hidden">

					<div class="loader"></div>

					<div class="centralizaconteudo">
						<div class="rss_des rss_delconfirm" data="" id="confirmadesarquivaaluno">&nbsp;&nbsp;desarquivar?&nbsp;&nbsp;</div>
						<div class="rss_del rss_delcancela" onclick="cancela();">cancelar</div>
					</div>
...
<script type="text/javascript">
	...
	function cancela()
	{
    	...
    	document.getElementById('rs_desarquivaaluno').classList.add('hidden');
	}
	...
	function opdesarquivar(rsidalunos)
    {
    	document.getElementById('rs_desarquivaaluno').classList.remove('hidden');

    	var divdelaluno = document.getElementById('confirmadesarquivaaluno');

    	divdelaluno.setAttribute("data", rsidalunos);
    }
...
var desarquivarals = document.getElementById('confirmadesarquivaaluno');


desarquivarals.addEventListener('click', function(e)
{
	  e.preventDefault();

	  document.getElementById('rs_desarquivaaluno').classList.add('hidden');

	  var url_checker = 'desarquiva_aluno.php?id=' + this.getAttribute("data");
