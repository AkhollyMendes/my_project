...
<div class="centralizaconteudo">
		<section class="content">
			...
			<div class="conteudo" id="conteudo">
				<form onsubmit="return false;" action="./loginaluno_sql.php" method="post" autocomplete="off" name="formulario_login_" id="formulario_login">

						
						<div class="cadiadologin"><img src="./layout/icone.jpg"></div>
						<p class="loginTitle">login aluno</p>
					...
					<div></div>
						...
						<button class="bt" alt="Click para autenticar" title="Click para autenticar"  id="send_login_">autenticar</button>

				</form>
						<button class="bt" alt="Click para voltar" title="Click para voltar"  id="send_login_"><a href="./">cancelar</a></button>
