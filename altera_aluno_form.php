...
?>
			...
			<form onsubmit="return false;" name="cadastra_fiscal" id="cadastra_fiscal" action="./altera_aluno_sql.php" method="post" autocomplete="off" enctype="multipart/form-data">
				...
				<div></div>
						...
						<button class="bt" alt="Click para autenticar" title="Click para autenticar"  id="send_login_"><a href="./painelaluno.php">sair</a></button>
