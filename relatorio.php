<div class="titulototalalunos">relatório</div>
...
<?php
		...
		for ($i = 0; $i < $busca->rowcount(); $i++)
		{
			...
			echo ('<span id="id'.$retorno->id.'" class="hidden">');
				...
				echo ('<div class="linhadescricao">&nbsp;<span class="titulo">disciplinas total</span>: 0</div>');
				echo ('<div class="linhadescricao">&nbsp;<span class="titulo">disciplinas aprovadas</span>: 0</div>');
				echo ('<div class="linhadescricao">&nbsp;<span class="titulo">disciplinas matriculadas</span>: 0</div>');
				echo ('<div class="linhadescricao">&nbsp;<span class="titulo">disciplinas pendentes</span>: 0</div>');
				echo ('<div class="baixar">&nbsp;<span class="titulo">:: baixar ::</span></div>');
